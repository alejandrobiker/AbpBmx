...
using CompetencyEvaluator.Blazor.Server.Host.Menus;
...
[DependsOn(
    ...
    typeof(CompetencyEvaluatorEntityFrameworkCoreModule),
    ...
    typeof(CompetencyEvaluatorBlazorServerModule)
)]
public class CompetencyEvaluatorBlazorHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                ...
                typeof(CompetencyEvaluatorDomainModule).Assembly,
                typeof(CompetencyEvaluatorDomainSharedModule).Assembly,
                typeof(CompetencyEvaluatorApplicationModule).Assembly,
                typeof(CompetencyEvaluatorApplicationContractsModule).Assembly,
                typeof(CompetencyEvaluatorBlazorHostModule).Assembly
            );
        });
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("CompetencyEvaluator");
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles("/CompetencyEvaluator.Blazor.Server.Host.styles.css");
                }
            );
        });
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<CompetencyEvaluatorDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}..{0}src{0}CompetencyEvaluator.Domain", Path.DirectorySeparatorChar)));
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<CompetencyEvaluatorApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}..{0}src{0}CompetencyEvaluator.Application", Path.DirectorySeparatorChar)));
                options.FileSets.ReplaceEmbeddedByPhysical<CompetencyEvaluatorBlazorHostModule>(hostingEnvironment.ContentRootPath);
            });
        }
        ...
        {
            options.AppAssembly = typeof(CompetencyEvaluatorBlazorHostModule).Assembly;
        });
