...
using CompetencyEvaluator.Blazor.WebAssembly;
...
[DependsOn(
    ...
    typeof(CompetencyEvaluatorBlazorWebAssemblyModule)
)]
public class CompetencyEvaluatorBlazorHostModule : AbpModule
{
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new CompetencyEvaluatorHostMenuContributor(context.Services.GetConfiguration()));
        });
    }
    ...
    private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
    {
        builder.Services.AddOidcAuthentication(options =>
        {
            ...
            options.ProviderOptions.DefaultScopes.Add("CompetencyEvaluator");
        });
    }
    ...
    private void ConfigureAutoMapper(ServiceConfigurationContext context)
    {
        ...
        {
            options.AddMaps<CompetencyEvaluatorBlazorHostModule>();
        });
    }
}
