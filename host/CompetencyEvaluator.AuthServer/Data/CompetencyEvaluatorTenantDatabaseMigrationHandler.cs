...
namespace CompetencyEvaluator.Data;

public class CompetencyEvaluatorTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<CompetencyEvaluatorTenantDatabaseMigrationHandler> _logger;

    public CompetencyEvaluatorTenantDatabaseMigrationHandler(
        IDbContextProvider<AuthServerHostMigrationsDbContext> dbContextProvider,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<CompetencyEvaluatorTenantDatabaseMigrationHandler> logger)
    {
