...
@Component({
  selector: 'lib-evaluation1-detail',
  ...
  templateUrl: './evaluation1-detail.component.html',
  styles: [],
})
export class Evaluation1DetailComponent {
  public readonly service = inject(Evaluation1DetailViewService);
}
